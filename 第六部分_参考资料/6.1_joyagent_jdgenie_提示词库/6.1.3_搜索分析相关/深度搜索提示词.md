...
## 查询分解提示词 (query_decompose_prompt)
...
## 来源文件
- `genie-tool/genie_tool/prompt/deepsearch.yaml`

## 功能说明
该模块包含深度搜索系统的各种提示词，用于查询分解、信息检索、推理评估和报告生成等功能，构成了完整的智能搜索分析流程。
