从明斯基提出“Agent”概念至今，AI Agent的发展经历了五个主要阶段，每个阶段在技术特点和应用场景上都有显著差异。
...
LLM-based Agent（基于大语言模型的Agent）：2020年代，大语言模型（LLM）的突破催生了新一代Agent。这些Agent不仅能处理自然语言，还能结合多模态数据执行复杂任务，成为当前AI研究的热点。