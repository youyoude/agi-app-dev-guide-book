...
![AGI应用架构图V1](前言部分/AGI应用架构图V1.png)

## 📖 关于本书

### 核心理念

本书基于硅谷技术专家Rakesh Gohel的深刻洞察："AI Agents are about 90% Software Engineering and only 10% AI"，系统性地阐述了如何从软件工程角度构建真正可用的企业级AGI应用。
...
### 2. 阅读指南
- 📖 从 [自序](自序.md) 开始了解作者的思考历程
- 🎯 阅读 [AGI应用概念](前言部分/AGI应用概念.md) 理解核心概念
- 📋 按照 [目录结构](SUMMARY.md) 系统学习
