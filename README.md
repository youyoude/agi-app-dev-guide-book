...
### 第六部分：参考资料
- 📚 **JoyAgent & JDGenie 提示词库**：丰富的Agentic AI应用提示词集合
  - 🤖 **Agent代理相关**：主代理系统、任务规划、工具调用提示词
  - 💻 **代码执行器相关**：代码解释器提示词模板
  - 🔍 **搜索分析相关**：深度搜索提示词集合
  - 📊 **报告生成相关**：各类报告生成提示词模板
- 🌐 **OpenHands翻译版提示词**：OpenHands项目核心提示词的中文翻译版本
  - 🤖 **Agent核心提示词**：CodeAct-Agent和ReadOnly-Agent的系统提示词
  - 🔧 **Resolver提示词**：问题解决和成功判断相关提示词
  - 🔗 **集成提示词**：GitHub、GitLab、Jira等平台集成提示词
  - 🛠️ **Microagents提示词**：代码审查、开发工具、版本控制微代理
  - 🎯 **辅助提示词**：可解决性评估、安全风险评估、记忆生成
- 📄 **OpenHands原版提示词**：OpenHands项目完整的英文原版提示词库
  - 🤖 **Agents**：CodeAct-Agent和ReadOnly-Agent的完整提示词体系
  - 🔗 **集成提示词**：多平台集成的原版提示词模板
  - 🔍 **Resolver提示词**：问题解决和成功判断的原版实现
  - 📊 **基准测试**：NoCode-Bench等基准测试提示词
  - 🛠️ **Microagents**：24个微代理的详细提示词文档
  - 🏢 **企业版**：企业级应用的专用提示词
  - 🔧 **其他工具**：Dockerfile模板和记忆生成等辅助工具
...
- **🤖 AI/ML工程师** → [第零部分：核心概念预览](第零部分_核心概念预览/0.0_全书概念框架.md) → [智能化工程](第四部分_智能化工程/)
...
- **🧠 智能工程** → [上下文工程](第四部分_智能化工程/4.1_知识记忆层与上下文工程/) | [智能思考工程](第四部分_智能化工程/4.2_智能思考工程/)
- **📚 实用资源** → [JoyAgent提示词库](第六部分_参考资料/6.1_joyagent_jdgenie_提示词库/README.md) | [OpenHands翻译版](第六部分_参考资料/6.2_OpenHands翻译版提示词/README.md) | [OpenHands原版](第六部分_参考资料/6.3_OpenHands原版提示词/README.md)
