...
> **AI应用软件开发90%是软件工程，只有10%才是AI**

一本面向传统软件开发者的AI应用软件开发实战指南，教你如何运用现有的软件工程知识，构建真正可用的企业级AI应用软件。
...
**AI应用软件（AI Application Software）** 是指具备智能涌现机制，能够创造出超越原始组件能力的新兴智能，并运用这些涌现能力自主完成任务的应用系统。
...
### 前言部分
- 📖 **AI应用软件概念**：深入理解AI应用软件的定义、特征和理论基础
- ⚙️ **AI应用软件开发90%是软件工程**：认识软件工程在AI应用软件开发中的核心地位
