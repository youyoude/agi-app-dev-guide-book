...
#### 🎯 根据你的背景选择起点
- **👨‍💻 传统软件开发者** → [核心概念预览](第一部分：背景与问题/0.0_核心概念预览.md) → [开发基础](第二部分_AGI应用的开发基础/)
- **🤖 AI/ML工程师** → [设计哲学](第三部分_开发思想与设计哲学/) → [智能大脑工程学](第四部分_智能大脑工程学/)
- **🏗️ 架构师/技术负责人** → [AGI应用概念](前言部分/AGI应用概念.md) → [核心进化](第五部分_核心进化/)
...
- 📚 [术语表](术语表.md) - 核心概念速查
- 🎯 [核心概念预览](第一部分：背景与问题/0.0_核心概念预览.md) - 知识框架
